...
- 2026-08-31 — A dead pooled HTTP/2 session stopped the server reaching FAL at all; transient transport failures retry, and `fetch failed` now names its cause (#556)
