...
- 2026-09-01 — Lighting: a button beside Shots that relights every staged reference under every effect picked, through every model picked. Two effects, no vision pass, no Anthropic key. Both dialogs now close on the press instead of the run (#563)
...
- 2026-08-30 — Shots' angle grid shows each camera position as a thumbnail generated by the feature itself; two of sixteen are kept as honest failures Nano Banana will not render (#553)
