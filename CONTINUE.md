# Continue: AI Images Multi-Select (complete)
...
- Batch delete loops individual delete functions (not a single batch DB call) to reuse existing per-image logic including hidden-root cleanup
